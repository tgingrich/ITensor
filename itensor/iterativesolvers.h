...
arnoldi(const BigMatrixT& A,
        ...
        Args const& args)
    {
    // constexpr int SELECTION_RULE = Spectra::LARGEST_MAGN;
    constexpr int SELECTION_RULE = Spectra::LARGEST_REAL;
    // constexpr int SELECTION_RULE = Spectra::LARGEST_IMAG;
    // constexpr int SELECTION_RULE = Spectra::SMALLEST_MAGN;
    // constexpr int SELECTION_RULE = Spectra::SMALLEST_REAL;
    // constexpr int SELECTION_RULE = Spectra::SMALLEST_IMAG;
